...
- [How to build with TypeSafe](https://docs.typesafe.ai/concepts/how-to-build-with-system-one) - Keep control flow in code; decompose into atomic questions; compose answers and route on uncertainty.
